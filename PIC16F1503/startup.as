	...
	; Compiler options:
	;
	; -oTPS-050040BCA-00_A-SV101.cof -mTPS-050040BCA-00_A-SV101.map \
	; --summary=default --output=default AD.p1 main.p1 PWM.p1 Register.p1 \
	; --chip=16F1503 -P --runtime=default --opt=default -D__DEBUG=1 -g \
